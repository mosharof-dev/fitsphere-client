...
export default function ComingSoon() {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-white/10 bg-[#0b1120]/50 backdrop-blur-sm p-8 sm:p-12 text-center min-h-[400px] shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
