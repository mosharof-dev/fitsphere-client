...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#020617] border-t border-cyan-500 text-white pt-10 pb-12 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-8 pr-0 lg:pr-8">
            ...
            <p className="text-slate-400 text-lg leading-relaxed max-w-sm">
              Transform your fitness journey with expert trainers, powerful
              classes, and a supportive community.
            </p>
            ...
            <ul className="space-y-4 text-slate-400 pt-4">
              <li>
                <a
                  ...
                  className="hover:text-[#06B6D4] transition-colors flex items-center group w-max"
                >
          ...
          <div className="lg:col-span-2 pt-2">
            <h4 className="text-white font-bold text-lg mb-8 tracking-wide">
              Quick Links
            </h4>
          ...
          <div className="lg:col-span-4 lg:pl-4">
            <div className="bg-[#0f172a]/60 backdrop-blur-xl border border-white/5 rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.4)] relative overflow-hidden group h-full flex flex-col justify-center">
              ...
              <h4 className="text-xl font-bold text-white mb-3 tracking-tight">
                Stay Updated With FitSphere
              </h4>
              <p className="text-slate-400 text-sm leading-relaxed mb-8">
                Get fitness tips, class updates, and exclusive community news
