...
import { Edit, Clock, CheckCircle2 } from "lucide-react";
...
export default function EditClassForm({ initialData }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      let uploadedUrl = initialData?.featured_image_url;
      ...
      const res = await updateClass(initialData._id, finalPayload);
      ...
      <div className="w-full mx-auto pb-6">
        ...
        <div className="flex flex-col gap-2 mb-8">
          <h1 className="text-3xl font-extrabold text-white tracking-tight flex items-center gap-2">
            <MdOutlineEditNote className="text-cyan-500 w-8 h-8" /> Edit Class
          </h1>
          <p className="text-slate-400 text-[14px] leading-relaxed max-w-2xl mt-1">
            Update your fitness class details below. Keep the information clear
            and engaging to help your students understand what you offer.
          </p>
        </div>
                  ...
                  >
                    {imageFile
                      ...
                      : initialData?.featured_image_url
                        ...
                        : "No class image selected"}
                  </span>
                </div>
                {(imageFile || initialData?.featured_image_url) && (
